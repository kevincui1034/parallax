...
async def generate_videos(state: dict) -> dict:
    ...
    if explode_result.success and explode_result.video_url:
        ...
        explode_data["frames"] = generate_placeholder_frames(settings.frame_count, "explode")
    ...
    if turntable_result.success and turntable_result.video_url:
        ...
        turntable_data["frames"] = generate_placeholder_frames(settings.frame_count, "turntable")
